...
% clear
% system('ls /data/geophys/scratch/jn6g09/CASCADIADATA/Event*/LHZ_processedbm_95/* > filelistCas2')
% fl=textread('filelistCas2','%s');
% fl=char(fl);
% 
% for i=1:length(fl) 
%  fl2=cellstr(fl(i,:));
...
% end
% 
% eval(['save /data/geophys/scratch/jn6g09/Beamforming/ts_Cas_LHZ_met2_12 ' 'beamp fr1']);
% clearvars -except Ntheta Ntime Nfrq I frq theta SL timestep
% save('var_Cas_LHZ_met2_12')

%% contour plot
clear all;close all;
load (['/data/geophys/scratch/jn6g09/Beamforming/ts_Cas_LHZ_met2_12.mat']); %output from section 1
load (['/data/geophys/scratch/jn6g09/Beamforming/var_Cas_LHZ_met2_12.mat']) % beamforming variables- slowness, frequency
